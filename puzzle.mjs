...
знания1.добавить(new Эквивалентность(new Или(БРыцарь, БЛжец), БРыцарь))
...
знания2.добавить(new Эквивалентность(new Или(БРыцарь, БЛжец), БРыцарь))
...
знания3.добавить(new Эквивалентность(new Или(АРыцарь, АЛжец), АРыцарь))
знания3.добавить(new Эквивалентность(ВРыцарь, new Не(ВЛжец)))
знания3.добавить(new Эквивалентность(new Или(ВРыцарь, ВЛжец), ВРыцарь)) 
